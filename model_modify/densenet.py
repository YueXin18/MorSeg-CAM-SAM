...
# you need to download the model_modify to ~/.torch/model_modify
# model_urls = {
...
models_dir = os.path.expanduser('~/.torch/model_modify')
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # Linear layer
        # print(num_features)             # num_features = 1024
    ...
    def forward(self, x):
        ...
        # out = F.avg_pool2d(out, kernel_size=7, stride=1).view(features.size(0_448_eval), -1)
        print(out.size())           # torch.size([1, 65536])
        # out = F.avg_pool2d(out, kernel_size=7).view(features.size(0_448_eval), -1)
        # 错误原因：65536要等于classifier的第一维度的大小
        # 448*448时，num_features = 1024
        # 224*224时，num_features = 1024，但out.size() = [1, 1024]
