...
input_tensor = # Create an input tensor image_448 for your model..
...
# will be used for every image_448 in the batch.
...
# In this example grayscale_cam has only one image_448 in the batch:
